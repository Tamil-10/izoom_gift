...
@Component({
  selector: 'app-giftscarousel',
  templateUrl: './giftscarousel.component.html',
  styleUrls: ['./giftscarousel.component.css'],
  animations: [btnAnim]
})
export class GiftsCarouselComponent implements OnInit, AfterViewInit {
